...
class TestData {
    ...
    (name: "Tricep ez bar", category: "Tricep", note: nil as String?, createdDate: date(2025, 11, 28, 16, 50, 36), lastUpdated: date(2025, 11, 28, 16, 54, 15)),
        ...
        func addBonusSet(exercise: String, weight: Double, reps: Int, timestamp: Date, isPauseAtTop: Bool = false, isTimedSet: Bool = false, tempoSeconds: Int = 0) {
            guard let ex = exercises[exercise] else { return }
        ...
        addSet(exercise: "Front lateral cable raise", weight: 23.0, reps: 15, timestamp: date(2025, 11, 5, 17, 36, 47))
        // Bicep rope curls: 1 sets
        ...
        // Dumbbell shoulder press: 2 sets
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 12, timestamp: date(2025, 11, 7, 17, 8, 20))
        ...
        // Single cable lateral raise: 3 sets
        addSet(exercise: "Single cable lateral raise", weight: 20.0, reps: 12, timestamp: date(2025, 11, 7, 17, 22, 41))
        ...
        // Tricep rope pushdown: 3 sets
        addSet(exercise: "Tricep rope pushdown", weight: 45.0, reps: 12, timestamp: date(2025, 11, 7, 17, 43, 0))
        ...
        // Pull ups: 3 sets
        addSet(exercise: "Pull ups", weight: 0.0, reps: 8, timestamp: date(2025, 11, 8, 16, 38, 8))
        ...
        addSet(exercise: "Incline chest press machine", weight: 45.0, reps: 8, timestamp: date(2025, 11, 23, 15, 55, 13))
        // Tricep Dips: 4 sets
        addSet(exercise: "Tricep Dips", weight: 0.0, reps: 10, timestamp: date(2025, 11, 23, 15, 58, 6))
        addSet(exercise: "Tricep Dips", weight: 7.5, reps: 9, timestamp: date(2025, 11, 23, 16, 2, 5))
        ...
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 12.5, reps: 9, timestamp: date(2025, 11, 24, 18, 12, 9))
        // Knees to toe: 3 sets
        ...
        addSet(exercise: "Leg press", weight: 140.0, reps: 11, timestamp: date(2025, 11, 25, 16, 56, 41))
        // Hamstring Curls: 5 sets
        ...
        // T Bar Row: 2 sets
        addSet(exercise: "T Bar Row", weight: 35.0, reps: 10, timestamp: date(2025, 11, 27, 15, 40, 29))
        addSet(exercise: "T Bar Row", weight: 35.0, reps: 10, timestamp: date(2025, 11, 27, 17, 28, 47))
        ...
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 12, timestamp: date(2025, 11, 28, 15, 51, 3))
        // Reverse Cable Flys: 3 sets
        addSet(exercise: "Reverse Cable Flys", weight: 17.5, reps: 14, timestamp: date(2025, 11, 28, 15, 55, 41))
        addSet(exercise: "Reverse Cable Flys", weight: 17.5, reps: 13, timestamp: date(2025, 11, 28, 15, 57, 55))
        addSet(exercise: "Reverse Cable Flys", weight: 17.5, reps: 11, timestamp: date(2025, 11, 28, 16, 0, 35))
        // Single cable lateral raise: 3 sets
        addSet(exercise: "Single cable lateral raise", weight: 23.0, reps: 10, timestamp: date(2025, 11, 28, 16, 4, 24), isPB: true)
        addSet(exercise: "Single cable lateral raise", weight: 23.0, reps: 10, timestamp: date(2025, 11, 28, 16, 5, 29))
        addDropSet(exercise: "Single cable lateral raise", weight: 23.0, reps: 10, timestamp: date(2025, 11, 28, 16, 9, 40))
        // Front lateral cable raise: 3 sets
        addSet(exercise: "Front lateral cable raise", weight: 17.5, reps: 15, timestamp: date(2025, 11, 28, 16, 10, 57))
        addSet(exercise: "Front lateral cable raise", weight: 23.0, reps: 16, timestamp: date(2025, 11, 28, 16, 13, 19), isPB: true)
        addSet(exercise: "Front lateral cable raise", weight: 23.0, reps: 14, timestamp: date(2025, 11, 28, 16, 15, 36))
        // Bicep rope curls: 3 sets
        addSet(exercise: "Bicep rope curls", weight: 50.5, reps: 16, timestamp: date(2025, 11, 28, 16, 17, 17))
        addSet(exercise: "Bicep rope curls", weight: 50.5, reps: 15, timestamp: date(2025, 11, 28, 16, 20, 32))
        addSet(exercise: "Bicep rope curls", weight: 50.5, reps: 13, timestamp: date(2025, 11, 28, 16, 22, 19))
        // Tricep rope pushdown: 3 sets
        addSet(exercise: "Tricep rope pushdown", weight: 45.0, reps: 13, timestamp: date(2025, 11, 28, 16, 25, 10), isPB: true)
        addSet(exercise: "Tricep rope pushdown", weight: 45.0, reps: 11, timestamp: date(2025, 11, 28, 16, 27, 24))
        addSet(exercise: "Tricep rope pushdown", weight: 45.0, reps: 10, timestamp: date(2025, 11, 28, 16, 29, 44))
        // Seated Incline Dumbell Curls: 3 sets
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 12.5, reps: 10, timestamp: date(2025, 11, 28, 16, 31, 56), isPB: true)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 12.5, reps: 10, timestamp: date(2025, 11, 28, 16, 34, 59))
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 12.5, reps: 7, timestamp: date(2025, 11, 28, 16, 37, 36))
        // Dumbbell hammer curls : 3 sets
        addSet(exercise: "Dumbbell hammer curls ", weight: 12.5, reps: 12, timestamp: date(2025, 11, 28, 16, 42, 4))
        addSet(exercise: "Dumbbell hammer curls ", weight: 12.5, reps: 12, timestamp: date(2025, 11, 28, 16, 42, 10))
        addSet(exercise: "Dumbbell hammer curls ", weight: 12.5, reps: 10, timestamp: date(2025, 11, 28, 16, 44, 29))
        // Tricep ez bar: 3 sets
        addSet(exercise: "Tricep ez bar", weight: 10.0, reps: 12, timestamp: date(2025, 11, 28, 16, 50, 50))
        addSet(exercise: "Tricep ez bar", weight: 10.0, reps: 12, timestamp: date(2025, 11, 28, 16, 51, 40))
        ...
        // Chest Press: 4 sets
        addSet(exercise: "Chest Press", weight: 50.0, reps: 8, timestamp: date(2025, 11, 29, 17, 18, 27))
        addSet(exercise: "Chest Press", weight: 50.0, reps: 10, timestamp: date(2025, 11, 29, 17, 20, 33))
        addSet(exercise: "Chest Press", weight: 55.0, reps: 8, timestamp: date(2025, 11, 29, 17, 23, 18))
        addSet(exercise: "Chest Press", weight: 55.0, reps: 9, timestamp: date(2025, 11, 29, 17, 26, 20))
        // Incline chest press machine: 4 sets
        addSet(exercise: "Incline chest press machine", weight: 40.0, reps: 6, timestamp: date(2025, 11, 29, 17, 29, 28))
        addSet(exercise: "Incline chest press machine", weight: 40.0, reps: 7, timestamp: date(2025, 11, 29, 17, 31, 25))
        addSet(exercise: "Incline chest press machine", weight: 40.0, reps: 8, timestamp: date(2025, 11, 29, 17, 33, 35))
        addSet(exercise: "Incline chest press machine", weight: 40.0, reps: 7, timestamp: date(2025, 11, 29, 17, 35, 50))
        // Tricep Dips: 4 sets
        addWarmUpSet(exercise: "Tricep Dips", weight: 0.0, reps: 12, timestamp: date(2025, 11, 29, 17, 38, 4))
        addWarmUpSet(exercise: "Tricep Dips", weight: 0.0, reps: 15, timestamp: date(2025, 11, 29, 17, 40, 40))
        addWarmUpSet(exercise: "Tricep Dips", weight: 0.0, reps: 13, timestamp: date(2025, 11, 29, 17, 43, 0))
        addWarmUpSet(exercise: "Tricep Dips", weight: 0.0, reps: 12, timestamp: date(2025, 11, 29, 17, 44, 57))

        // SESSION 51: 2025-12-01 16:26:26
        // Pull ups: 4 sets
        addSet(exercise: "Pull ups", weight: 0.0, reps: 7, timestamp: date(2025, 12, 1, 16, 26, 26))
        addSet(exercise: "Pull ups", weight: 0.0, reps: 9, timestamp: date(2025, 12, 1, 16, 28, 16), isPB: true)
        addSet(exercise: "Pull ups", weight: 0.0, reps: 6, timestamp: date(2025, 12, 1, 16, 30, 11))
        addSet(exercise: "Pull ups", weight: 0.0, reps: 7, timestamp: date(2025, 12, 1, 16, 33, 4))
        // T Bar Row: 3 sets
        addSet(exercise: "T Bar Row", weight: 35.0, reps: 10, timestamp: date(2025, 12, 1, 16, 36, 20))
        addSet(exercise: "T Bar Row", weight: 35.0, reps: 11, timestamp: date(2025, 12, 1, 16, 42, 55))
        addSet(exercise: "T Bar Row", weight: 35.0, reps: 10, timestamp: date(2025, 12, 1, 16, 43, 39))
        // Reverse Cable Flys: 3 sets
        addSet(exercise: "Reverse Cable Flys", weight: 17.5, reps: 15, timestamp: date(2025, 12, 1, 16, 48, 54), isPB: true)
        addSet(exercise: "Reverse Cable Flys", weight: 17.5, reps: 15, timestamp: date(2025, 12, 1, 16, 51, 15))
        addSet(exercise: "Reverse Cable Flys", weight: 17.5, reps: 15, timestamp: date(2025, 12, 1, 16, 54, 40))
        // Seated Incline Dumbell Curls: 3 sets
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 12.5, reps: 10, timestamp: date(2025, 12, 1, 16, 57, 24))
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 12.5, reps: 9, timestamp: date(2025, 12, 1, 17, 0, 3))
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 12.5, reps: 9, timestamp: date(2025, 12, 1, 17, 2, 34))
        // Dumbbell hammer curls : 3 sets
        addSet(exercise: "Dumbbell hammer curls ", weight: 12.5, reps: 14, timestamp: date(2025, 12, 1, 17, 5, 7))
        addSet(exercise: "Dumbbell hammer curls ", weight: 12.5, reps: 10, timestamp: date(2025, 12, 1, 17, 9, 1))
        addSet(exercise: "Dumbbell hammer curls ", weight: 12.5, reps: 10, timestamp: date(2025, 12, 1, 17, 9, 47))

        // SESSION 52: 2025-12-03 16:40:37
        // Incline chest press machine: 4 sets
        addSet(exercise: "Incline chest press machine", weight: 30.0, reps: 12, timestamp: date(2025, 12, 3, 16, 40, 37))
        addSet(exercise: "Incline chest press machine", weight: 40.0, reps: 11, timestamp: date(2025, 12, 3, 16, 47, 10))
        addSet(exercise: "Incline chest press machine", weight: 45.0, reps: 10, timestamp: date(2025, 12, 3, 16, 50, 11), isPB: true)
        addSet(exercise: "Incline chest press machine", weight: 45.0, reps: 10, timestamp: date(2025, 12, 3, 16, 52, 32))
        // Chest Press: 3 sets
        addWarmUpSet(exercise: "Chest Press", weight: 40.0, reps: 10, timestamp: date(2025, 12, 3, 16, 54, 20))
        addSet(exercise: "Chest Press", weight: 55.0, reps: 8, timestamp: date(2025, 12, 3, 16, 57, 29))
        addSet(exercise: "Chest Press", weight: 55.0, reps: 6, timestamp: date(2025, 12, 3, 16, 59, 25))
        // Tricep Dips: 3 sets
        addSet(exercise: "Tricep Dips", weight: 7.5, reps: 10, timestamp: date(2025, 12, 3, 17, 6, 4))
        addSet(exercise: "Tricep Dips", weight: 7.5, reps: 10, timestamp: date(2025, 12, 3, 17, 8, 20))
        addSet(exercise: "Tricep Dips", weight: 7.5, reps: 11, timestamp: date(2025, 12, 3, 17, 12, 0))
        // Single cable lateral raise: 4 sets
        addWarmUpSet(exercise: "Single cable lateral raise", weight: 17.5, reps: 10, timestamp: date(2025, 12, 3, 17, 15, 54))
        addSet(exercise: "Single cable lateral raise", weight: 20.0, reps: 10, timestamp: date(2025, 12, 3, 17, 18, 24))
        addSet(exercise: "Single cable lateral raise", weight: 20.0, reps: 12, timestamp: date(2025, 12, 3, 17, 21, 1))
        addSet(exercise: "Single cable lateral raise", weight: 20.0, reps: 12, timestamp: date(2025, 12, 3, 17, 24, 4))
        // Dumbbell shoulder press: 3 sets
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 15, timestamp: date(2025, 12, 3, 17, 26, 34))
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 10, timestamp: date(2025, 12, 3, 17, 29, 13))
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 10, timestamp: date(2025, 12, 3, 17, 31, 50))
        // Chest Cable Flys: 4 sets
        addWarmUpSet(exercise: "Chest Cable Flys", weight: 15.0, reps: 15, timestamp: date(2025, 12, 3, 17, 35, 17))
        addSet(exercise: "Chest Cable Flys", weight: 17.5, reps: 15, timestamp: date(2025, 12, 3, 17, 37, 18))
        addSet(exercise: "Chest Cable Flys", weight: 20.0, reps: 14, timestamp: date(2025, 12, 3, 17, 40, 21))
        addSet(exercise: "Chest Cable Flys", weight: 20.0, reps: 15, timestamp: date(2025, 12, 3, 17, 42, 45))
        // Overhead Tricep Rope Pulls: 4 sets
        addSet(exercise: "Overhead Tricep Rope Pulls", weight: 34.0, reps: 12, timestamp: date(2025, 12, 3, 17, 45, 0))
        addSet(exercise: "Overhead Tricep Rope Pulls", weight: 34.0, reps: 16, timestamp: date(2025, 12, 3, 17, 47, 31))
        addSet(exercise: "Overhead Tricep Rope Pulls", weight: 36.5, reps: 15, timestamp: date(2025, 12, 3, 17, 50, 25))
        addSet(exercise: "Overhead Tricep Rope Pulls", weight: 36.5, reps: 12, timestamp: date(2025, 12, 3, 17, 52, 31))

        // SESSION 53: 2025-12-10 20:36:36
        // Tricep Dips: 3 sets
        addWarmUpSet(exercise: "Tricep Dips", weight: 7.5, reps: 11, timestamp: date(2025, 12, 10, 20, 36, 36))
        addSet(exercise: "Tricep Dips", weight: 7.5, reps: 11, timestamp: date(2025, 12, 10, 20, 36, 59))
        addSet(exercise: "Tricep Dips", weight: 7.5, reps: 15, timestamp: date(2025, 12, 10, 20, 37, 32))

        // SESSION 54: 2025-12-12 15:09:12
        // Tricep Dips: 3 sets
        addSet(exercise: "Tricep Dips", weight: 7.5, reps: 15, timestamp: date(2025, 12, 12, 15, 9, 12))
        addSet(exercise: "Tricep Dips", weight: 10.0, reps: 6, timestamp: date(2025, 12, 12, 15, 9, 55), isPB: true)
        addSet(exercise: "Tricep Dips", weight: 10.0, reps: 6, timestamp: date(2025, 12, 12, 16, 9, 12))

        // SESSION 55: 2025-12-29 16:19:55
        // Chest Press: 5 sets
        addWarmUpSet(exercise: "Chest Press", weight: 20.0, reps: 12, timestamp: date(2025, 12, 29, 16, 19, 55))
        addSet(exercise: "Chest Press", weight: 50.0, reps: 8, timestamp: date(2025, 12, 29, 16, 21, 4))
        addSet(exercise: "Chest Press", weight: 55.0, reps: 8, timestamp: date(2025, 12, 29, 16, 24, 45))
        addSet(exercise: "Chest Press", weight: 60.0, reps: 5, timestamp: date(2025, 12, 29, 16, 28, 33), isPB: true)
        addSet(exercise: "Chest Press", weight: 60.0, reps: 5, timestamp: date(2025, 12, 29, 16, 32, 30))
        // Incline Dumbbell Chest Press: 3 sets
        addSet(exercise: "Incline Dumbbell Chest Press", weight: 22.5, reps: 10, timestamp: date(2025, 12, 29, 16, 36, 7))
        addSet(exercise: "Incline Dumbbell Chest Press", weight: 22.5, reps: 10, timestamp: date(2025, 12, 29, 16, 38, 56))
        addSet(exercise: "Incline Dumbbell Chest Press", weight: 22.5, reps: 10, timestamp: date(2025, 12, 29, 16, 42, 11))
        // Chest Cable Flys: 2 sets
        addSet(exercise: "Chest Cable Flys", weight: 20.0, reps: 12, timestamp: date(2025, 12, 29, 16, 45, 5))
        addSet(exercise: "Chest Cable Flys", weight: 20.0, reps: 15, timestamp: date(2025, 12, 29, 16, 49, 11))
        // Single cable lateral raise: 3 sets
        addSet(exercise: "Single cable lateral raise", weight: 17.5, reps: 15, timestamp: date(2025, 12, 29, 16, 52, 49))
        addSet(exercise: "Single cable lateral raise", weight: 17.5, reps: 15, timestamp: date(2025, 12, 29, 16, 55, 13))
        addSet(exercise: "Single cable lateral raise", weight: 17.5, reps: 15, timestamp: date(2025, 12, 29, 16, 59, 0))
        // Tricep Dips: 4 sets
        addWarmUpSet(exercise: "Tricep Dips", weight: 0.0, reps: 10, timestamp: date(2025, 12, 29, 17, 1, 2))
        addBonusSet(exercise: "Tricep Dips", weight: 5.0, reps: 10, timestamp: date(2025, 12, 29, 17, 3, 1))
        addBonusSet(exercise: "Tricep Dips", weight: 0.0, reps: 10, timestamp: date(2025, 12, 29, 17, 5, 42))
        addBonusSet(exercise: "Tricep Dips", weight: 0.0, reps: 10, timestamp: date(2025, 12, 29, 17, 7, 49))
        // Overhead Tricep Rope Pulls: 4 sets
        addSet(exercise: "Overhead Tricep Rope Pulls", weight: 34.0, reps: 15, timestamp: date(2025, 12, 29, 17, 11, 21))
        addSet(exercise: "Overhead Tricep Rope Pulls", weight: 36.5, reps: 12, timestamp: date(2025, 12, 29, 17, 13, 17))
        addSet(exercise: "Overhead Tricep Rope Pulls", weight: 36.5, reps: 12, timestamp: date(2025, 12, 29, 17, 15, 48))
        addSet(exercise: "Overhead Tricep Rope Pulls", weight: 36.5, reps: 9, timestamp: date(2025, 12, 29, 17, 17, 33))
