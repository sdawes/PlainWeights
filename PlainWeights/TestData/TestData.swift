...
//  Last Updated: 3 Feb 2026 at 20:59:08
//
//  Real Gym Data
//  67 exercises, 69 workout sessions (22 Sep 2025 - 03 Feb 2026)
...
class TestData {
    ...
    static func generate(modelContext: ModelContext) {
        ...
        logger.info("Generating test data (Real gym data - 67 exercises, 69 sessions)...")
    ...
    private static func generateGymData(modelContext: ModelContext) {
        // EXPORT DATE: 3 Feb 2026 at 20:59:08
    ...
    (name: "Romanian deadlift ", tags: ["legs", "hammies", "glutes", "posterior chain"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 1, 6, 16, 45, 7)),
    (name: "Butterfly sit up", tags: ["core", "abs"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2025, 9, 26, 16, 59, 27)),
    (name: "Knees to toe", tags: ["core", "abs", "lower abs"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 1, 14, 17, 19, 25)),
    (name: "Lat pull down", tags: ["back", "lats"], note: "6- 47.5, 7- 48.5, 8 - 54, 9 - 59.5kg, 10 - 65kg", createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 1, 29, 17, 4, 5)),
    (name: "Dumbbell split squats", tags: ["legs", "quads", "glutes"], note: "Number of reps done on one side logged", createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2025, 11, 25, 17, 23, 28)),
    (name: "Sled Push", tags: ["legs", "quads", "glutes", "conditioning"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2025, 10, 6, 17, 6, 21)),
    (name: "Dumbbell shoulder shrugs", tags: ["shoulders", "traps"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2025, 10, 1, 20, 50, 58)),
    (name: "Chest Press", tags: ["chest", "pecs", "mid chest"], note: "Start with 60 it’s fine!", createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 2, 3, 16, 25, 46)),
    (name: "Seated cable row", tags: ["back", "lats", "rhomboids", "mid back"], note: "8 is 54kg, 9 is 59.5kg", createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 1, 25, 16, 23, 37)),
    (name: "Seated tricep dips", tags: ["arms", "tris"], note: "With bench level box full out", createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2025, 11, 5, 17, 58, 47)),
    (name: "Cable chest flys mid", tags: ["chest", "pecs", "mid chest"], note: "6 holes from the top", createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2025, 11, 1, 9, 17, 4)),
    (name: "Standing dumbbell hammer curls", tags: ["arms", "bis", "brachialis", "forearms"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2025, 10, 21, 17, 53, 6)),
    (name: "Straight arm cable pulldown", tags: ["back", "lats"], note: "8 is 45kg 9 is 50.5", createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2025, 11, 22, 15, 30, 32)),
    (name: "Deadlifts (Trapbar)", tags: ["back", "traps", "glutes", "hammies", "posterior chain"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 1, 14, 16, 25, 47)),
    (name: "Chest press machine", tags: ["chest", "pecs", "mid chest"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2025, 10, 17, 13, 31, 21)),
    (name: "Barbell Lunges", tags: ["legs", "quads", "glutes"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2025, 9, 30, 17, 7, 30)),
    (name: "Reverse Cable Flys", tags: ["back", "rear delts", "rhomboids"], note: "2 15 and 3 17.5", createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 1, 29, 17, 13, 41)),
    (name: "Bicep rope curls", tags: ["arms", "bis"], note: "8 is 45kg, , 9 is 50.5", createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 1, 29, 17, 22, 2)),
    (name: "Incline chest press machine", tags: ["chest", "pecs", "upper chest"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2025, 12, 3, 16, 52, 32)),
    (name: "Dumbbell flys", tags: ["chest", "pecs", "inner chest"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 1, 7, 17, 7, 34)),
    (name: "Overhead Tricep Rope Pulls", tags: ["arms", "tris", "long head"], note: "7 is 39.5, 8 is 45", createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 1, 7, 17, 35, 27)),
    (name: "Hyper extensions", tags: ["back", "lower back", "glutes", "hammies"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2025, 10, 28, 17, 47, 19)),
    (name: "Dumbbell shoulder press", tags: ["shoulders", "delts", "front delts"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 2, 3, 16, 58, 24)),
    (name: "Box jumps", tags: ["legs", "quads", "glutes", "plyometrics"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2025, 11, 25, 17, 47, 13)),
    (name: "Single cable lateral raise", tags: ["shoulders", "side delts"], note: "2 - 15kg, 3 - 17.5", createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 2, 3, 16, 41, 47)),
    (name: "Pull ups", tags: ["back", "lats", "bis"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 1, 29, 16, 36, 41)),
    (name: "Chest Cable Flys", tags: ["chest", "pecs", "inner chest"], note: "3 is 17.5 and 4 is 23", createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 2, 3, 16, 33, 43)),
    (name: "Dumbbell lunges", tags: ["legs", "quads", "glutes"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2025, 11, 21, 23, 51, 8)),
    (name: "Ball tricep pushdown", tags: ["arms", "tris"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 1, 27, 17, 33, 41)),
    (name: "Calf Raises", tags: ["legs", "calves"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 1, 25, 17, 5, 46)),
    (name: "Tricep rope pushdown", tags: ["arms", "tris"], note: "7 - 39.5, 7 plus weight - 42, 8 - 45", createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 2, 3, 17, 14, 24)),
    (name: "Dumbbell lateral raises", tags: ["shoulders", "side delts"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 1, 27, 17, 26, 28)),
    (name: "Press ups", tags: ["chest", "pecs", "tris", "front delts"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 1, 30, 17, 54, 29)),
    (name: "Front lateral cable raise", tags: ["shoulders", "front delts"], note: "3 is 17.5, 4 23 and 5 28.5, 2 handed pull", createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2025, 11, 28, 16, 15, 36)),
    (name: "Reverse dumbbell lateral flys", tags: ["back", "rear delts", "rhomboids"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 1, 4, 15, 27, 8)),
    (name: "Seated dumbbell curl (on knee)", tags: ["arms", "bis"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2025, 11, 5, 17, 58, 15)),
    (name: "EZ bar curl", tags: ["arms", "bis"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2025, 11, 3, 17, 38, 25)),
    (name: "Dumbbell chest press", tags: ["chest", "pecs", "mid chest"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2025, 11, 18, 17, 15, 24)),
    (name: "Leg Raises", tags: ["legs", "quads"], note: "6 is 43kg, 7 is 48.5, 8 is 54, 9 is 59.5, 10 is 65", createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 1, 6, 16, 14, 19)),
    (name: "Incline Dumbbell Chest Press", tags: ["chest", "pecs", "upper chest"], note: "Include the raise as one", createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 2, 3, 16, 50, 7)),
    (name: "Toes to bar", tags: ["core", "abs", "lower abs"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2025, 11, 9, 16, 37, 31)),
    (name: "Seated dumbbell Arnold press", tags: ["shoulders", "delts", "front delts"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2025, 10, 29, 17, 25, 39)),
    (name: "Shoulder press machine ", tags: ["shoulders", "delts", "front delts"], note: "4 - 32kg, 5 - 37.5, 6 - 43kg", createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2025, 11, 5, 17, 14, 33)),
    (name: "Hamstring Curls", tags: ["legs", "hammies"], note: "4 is 32kg, 5 is 37.5, 6 is 43kg, 7 is 48.5kg", createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 1, 7, 12, 8, 23)),
    (name: "Seated Incline Dumbell Curls", tags: ["arms", "bis"], note: "Bench number 5", createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 1, 25, 16, 54, 2)),
    (name: "Landmine Row", tags: ["back", "lats", "rhomboids"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2025, 10, 23, 19, 26, 42)),
    (name: "Landmine Shoulder Press", tags: ["shoulders", "delts", "front delts"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2025, 10, 23, 19, 18, 45)),
    (name: "Barbell squat", tags: ["legs", "quads", "glutes"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 1, 6, 17, 0, 17)),
    (name: "Front lateral dumbbell raise", tags: ["shoulders", "front delts"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2025, 10, 29, 17, 36, 55)),
    (name: "Tricep Dips", tags: ["arms", "tris", "chest"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 2, 3, 17, 5, 59)),
    (name: "T Bar Row", tags: ["back", "lats", "rhomboids", "mid back"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 1, 14, 16, 44, 6)),
    (name: "Leg press", tags: ["legs", "quads", "glutes"], note: nil as String?, createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 1, 6, 16, 28, 48)),
    (name: "Dumbbell hammer curls ", tags: ["arms", "bis", "brachialis", "forearms"], note: "Single arm raises each count as one rep.", createdDate: date(2025, 11, 8, 16, 9, 47), lastUpdated: date(2026, 1, 13, 21, 26, 26)),
    (name: "Single arm back pull machine", tags: ["back", "lats"], note: nil as String?, createdDate: date(2025, 11, 9, 16, 6, 34), lastUpdated: date(2025, 11, 9, 16, 14, 21)),
    (name: "Barbell shoulder press", tags: ["shoulders", "delts", "front delts"], note: nil as String?, createdDate: date(2025, 11, 10, 18, 2, 11), lastUpdated: date(2026, 1, 29, 16, 48, 44)),
    (name: "Deadlifts", tags: ["back", "posterior chain", "glutes", "hammies", "traps"], note: nil as String?, createdDate: date(2025, 11, 20, 16, 25, 23), lastUpdated: date(2025, 11, 20, 16, 33, 10)),
    (name: "Dumbbell Romanian deadlift", tags: ["legs", "hammies", "glutes", "posterior chain"], note: nil as String?, createdDate: date(2025, 11, 25, 17, 12, 23), lastUpdated: date(2025, 11, 25, 17, 15, 30)),
    (name: "Tricep ez bar", tags: ["arms", "tris"], note: nil as String?, createdDate: date(2025, 11, 28, 16, 50, 36), lastUpdated: date(2025, 11, 28, 16, 54, 15)),
    (name: "Neutral grip pull ups", tags: ["back", "lats", "bis"], note: nil as String?, createdDate: date(2026, 1, 4, 15, 41, 16), lastUpdated: date(2026, 1, 9, 15, 48, 36)),
    (name: "Hang cleans", tags: ["posterior chain", "traps", "glutes", "explosive"], note: nil as String?, createdDate: date(2026, 1, 6, 17, 6, 20), lastUpdated: date(2026, 1, 6, 17, 10, 35)),
    (name: "Front barbell squat", tags: ["legs", "quads", "core"], note: nil as String?, createdDate: date(2026, 1, 6, 17, 11, 52), lastUpdated: date(2026, 1, 6, 17, 12, 38)),
    (name: "Lu Raise", tags: ["shoulders", "side delts", "front delts"], note: nil as String?, createdDate: date(2026, 1, 7, 17, 38, 9), lastUpdated: date(2026, 1, 7, 17, 40, 40)),
    (name: "Front lateral raise plates", tags: ["shoulders", "front delts"], note: nil as String?, createdDate: date(2026, 1, 7, 17, 38, 52), lastUpdated: date(2026, 1, 7, 17, 40, 46)),
    (name: "Single arm bicep cable curl", tags: ["arms", "bis"], note: nil as String?, createdDate: date(2026, 1, 14, 17, 7, 34), lastUpdated: date(2026, 1, 14, 17, 12, 10)),
    (name: "Plate loaded lat pulldown", tags: ["back", "lats"], note: nil as String?, createdDate: date(2026, 1, 25, 16, 30, 4), lastUpdated: date(2026, 1, 25, 16, 33, 55)),
    (name: "Angled rope row", tags: ["back", "rear delts", "rhomboids"], note: nil as String?, createdDate: date(2026, 1, 29, 16, 40, 39), lastUpdated: date(2026, 1, 29, 16, 46, 28)),
    (name: "Face pulls", tags: ["back", "rear delts", "rhomboids", "rotator cuff"], note: "Height 5", createdDate: date(2026, 1, 29, 17, 16, 34), lastUpdated: date(2026, 1, 29, 17, 18, 0)),
        ]

        // Create exercises
        var exercises: [String: Exercise] = [:]
        for data in exerciseData {
            let exercise = Exercise(name: data.name, tags: data.tags, note: data.note, createdDate: data.createdDate)
        ...
        // Tricep Dips: 3 sets
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 8, timestamp: date(2025, 9, 22, 17, 25, 0), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 8, timestamp: date(2025, 9, 22, 17, 30, 0), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 8, timestamp: date(2025, 9, 22, 17, 33, 0), restSeconds: 60)
        ...
        addSet(exercise: "Barbell squat", weight: 50.0, reps: 10, timestamp: date(2025, 9, 22, 18, 0, 0), restSeconds: 60)
        addSet(exercise: "Barbell squat", weight: 50.0, reps: 10, timestamp: date(2025, 9, 22, 18, 3, 0), restSeconds: 60)
        addSet(exercise: "Barbell squat", weight: 50.0, reps: 10, timestamp: date(2025, 9, 22, 18, 5, 0), restSeconds: 60)
        ...
        // Calf Raises: 3 sets
        addSet(exercise: "Calf Raises", weight: 40.0, reps: 12, timestamp: date(2025, 9, 22, 18, 40, 0), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 40.0, reps: 12, timestamp: date(2025, 9, 22, 18, 43, 0), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 40.0, reps: 12, timestamp: date(2025, 9, 22, 18, 45, 0), restSeconds: 60)
        ...
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 10, timestamp: date(2025, 9, 24, 17, 14, 0), restSeconds: 60)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 10, timestamp: date(2025, 9, 24, 17, 16, 0), restSeconds: 60)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 10, timestamp: date(2025, 9, 24, 17, 18, 0), restSeconds: 60)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 10, timestamp: date(2025, 9, 24, 17, 20, 0), restSeconds: 60)
        ...
        // Calf Raises: 2 sets
        addSet(exercise: "Calf Raises", weight: 40.0, reps: 15, timestamp: date(2025, 9, 25, 17, 7, 26), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 40.0, reps: 15, timestamp: date(2025, 9, 25, 17, 8, 47), restSeconds: 60)
        // Barbell squat: 5 sets
        addWarmUpSet(exercise: "Barbell squat", weight: 20.0, reps: 15, timestamp: date(2025, 9, 25, 17, 13, 4), restSeconds: 60)
        addSet(exercise: "Barbell squat", weight: 40.0, reps: 8, timestamp: date(2025, 9, 25, 17, 15, 31), restSeconds: 60)
        addSet(exercise: "Barbell squat", weight: 50.0, reps: 8, timestamp: date(2025, 9, 25, 17, 19, 39), restSeconds: 60)
        addSet(exercise: "Barbell squat", weight: 50.0, reps: 8, timestamp: date(2025, 9, 25, 17, 19, 44), restSeconds: 60)
        addSet(exercise: "Barbell squat", weight: 50.0, reps: 8, timestamp: date(2025, 9, 25, 17, 21, 54), restSeconds: 60)
        // Barbell Lunges: 3 sets
        ...
        // Tricep Dips: 4 sets
        addWarmUpSet(exercise: "Tricep Dips", weight: 0.0, reps: 8, timestamp: date(2025, 9, 27, 17, 15, 10), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 7, timestamp: date(2025, 9, 27, 17, 17, 1), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 7, timestamp: date(2025, 9, 27, 17, 19, 23), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 7, timestamp: date(2025, 9, 27, 17, 21, 59), restSeconds: 60)
        ...
        addSet(exercise: "Straight arm cable pulldown", weight: 45.0, reps: 13, timestamp: date(2025, 9, 29, 17, 6, 7), restSeconds: 60)
        addSet(exercise: "Straight arm cable pulldown", weight: 47.5, reps: 12, timestamp: date(2025, 9, 29, 17, 8, 3), restSeconds: 60)
        addSet(exercise: "Straight arm cable pulldown", weight: 47.5, reps: 10, timestamp: date(2025, 9, 29, 17, 10, 0), restSeconds: 60)
        // T Bar Row: 4 sets
        ...
        // Seated Incline Dumbell Curls: 4 sets
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 11, timestamp: date(2025, 9, 29, 17, 30, 21), restSeconds: 60)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 10, timestamp: date(2025, 9, 29, 17, 32, 0), restSeconds: 60)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 11, timestamp: date(2025, 9, 29, 17, 35, 9), restSeconds: 60)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 11, timestamp: date(2025, 9, 29, 17, 38, 39), restSeconds: 60)
        // Bicep rope curls: 4 sets
        ...
        // Barbell squat: 5 sets
        addWarmUpSet(exercise: "Barbell squat", weight: 20.0, reps: 15, timestamp: date(2025, 9, 30, 16, 48, 49), restSeconds: 60)
        addSet(exercise: "Barbell squat", weight: 50.0, reps: 10, timestamp: date(2025, 9, 30, 16, 51, 24), restSeconds: 60)
        addSet(exercise: "Barbell squat", weight: 50.0, reps: 10, timestamp: date(2025, 9, 30, 16, 54, 4), restSeconds: 60)
        addSet(exercise: "Barbell squat", weight: 50.0, reps: 10, timestamp: date(2025, 9, 30, 16, 56, 13), restSeconds: 60)
        addSet(exercise: "Barbell squat", weight: 50.0, reps: 10, timestamp: date(2025, 9, 30, 16, 58, 25), restSeconds: 60)
        // Barbell Lunges: 3 sets
        ...
        // Calf Raises: 3 sets
        addSet(exercise: "Calf Raises", weight: 45.0, reps: 15, timestamp: date(2025, 9, 30, 17, 25, 5), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 45.0, reps: 15, timestamp: date(2025, 9, 30, 17, 26, 46), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 45.0, reps: 15, timestamp: date(2025, 9, 30, 17, 28, 16), restSeconds: 60)
        ...
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 10, timestamp: date(2025, 10, 1, 20, 27, 20), restSeconds: 60)
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 10, timestamp: date(2025, 10, 1, 20, 30, 46), restSeconds: 60)
        // Single cable lateral raise: 3 sets
        ...
        // Tricep Dips: 4 sets
        addWarmUpSet(exercise: "Tricep Dips", weight: 0.0, reps: 8, timestamp: date(2025, 10, 2, 16, 45, 5), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 8, timestamp: date(2025, 10, 2, 16, 46, 50), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 8, timestamp: date(2025, 10, 2, 16, 50, 5), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 7, timestamp: date(2025, 10, 2, 16, 52, 55), restSeconds: 60)
        ...
        // Seated Incline Dumbell Curls: 4 sets
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 11, timestamp: date(2025, 10, 4, 10, 32, 58), restSeconds: 60)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 12, timestamp: date(2025, 10, 4, 10, 35, 38), restSeconds: 60)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 12, timestamp: date(2025, 10, 4, 10, 38, 16), restSeconds: 60)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 12.5, reps: 6, timestamp: date(2025, 10, 4, 10, 39, 52), restSeconds: 60)
        ...
        // Calf Raises: 4 sets
        addSet(exercise: "Calf Raises", weight: 40.0, reps: 15, timestamp: date(2025, 10, 6, 17, 8, 17), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 45.0, reps: 14, timestamp: date(2025, 10, 6, 17, 10, 46), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 45.0, reps: 14, timestamp: date(2025, 10, 6, 17, 13, 9), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 45.0, reps: 15, timestamp: date(2025, 10, 6, 17, 15, 49), restSeconds: 60)
        ...
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 9, timestamp: date(2025, 10, 7, 17, 4, 44), restSeconds: 60)
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 9, timestamp: date(2025, 10, 7, 17, 6, 31), restSeconds: 60)
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 9, timestamp: date(2025, 10, 7, 17, 11, 32), restSeconds: 60)
        // Tricep Dips: 4 sets
        addWarmUpSet(exercise: "Tricep Dips", weight: 0.0, reps: 7, timestamp: date(2025, 10, 7, 17, 11, 44), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 9, timestamp: date(2025, 10, 7, 17, 13, 12), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 8, timestamp: date(2025, 10, 7, 17, 15, 43), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 8, timestamp: date(2025, 10, 7, 17, 19, 19), restSeconds: 60)
        ...
        // Straight arm cable pulldown: 3 sets
        addSet(exercise: "Straight arm cable pulldown", weight: 45.0, reps: 14, timestamp: date(2025, 10, 8, 16, 54, 55), restSeconds: 60)
        addSet(exercise: "Straight arm cable pulldown", weight: 50.0, reps: 9, timestamp: date(2025, 10, 8, 16, 56, 31), restSeconds: 60)
        addSet(exercise: "Straight arm cable pulldown", weight: 50.0, reps: 9, timestamp: date(2025, 10, 8, 16, 58, 2), restSeconds: 60)
        // Seated Incline Dumbell Curls: 4 sets
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 12.5, reps: 8, timestamp: date(2025, 10, 8, 16, 59, 49), restSeconds: 60)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 12.5, reps: 7, timestamp: date(2025, 10, 8, 17, 1, 55), restSeconds: 60)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 12.5, reps: 7, timestamp: date(2025, 10, 8, 17, 3, 54), restSeconds: 60)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 12.5, reps: 7, timestamp: date(2025, 10, 8, 17, 7, 19), restSeconds: 60)
        // Bicep rope curls: 4 sets
        ...
        // Calf Raises: 4 sets
        addSet(exercise: "Calf Raises", weight: 50.0, reps: 15, timestamp: date(2025, 10, 11, 8, 44, 4), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 50.0, reps: 15, timestamp: date(2025, 10, 11, 8, 49, 52), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 50.0, reps: 15, timestamp: date(2025, 10, 11, 8, 49, 53), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 50.0, reps: 14, timestamp: date(2025, 10, 11, 8, 49, 56), restSeconds: 60)
        ...
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 10, timestamp: date(2025, 10, 11, 9, 12, 53), restSeconds: 60)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 10, timestamp: date(2025, 10, 11, 9, 14, 45), restSeconds: 60)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 12, timestamp: date(2025, 10, 11, 9, 19, 16), restSeconds: 60)
        ...
        // Tricep Dips: 4 sets
        addWarmUpSet(exercise: "Tricep Dips", weight: 0.0, reps: 8, timestamp: date(2025, 10, 13, 19, 44, 17), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 7, timestamp: date(2025, 10, 13, 19, 45, 53), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 10, timestamp: date(2025, 10, 13, 19, 48, 14), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 9, timestamp: date(2025, 10, 13, 19, 50, 56), restSeconds: 60)
        ...
        addSet(exercise: "Straight arm cable pulldown", weight: 50.0, reps: 11, timestamp: date(2025, 10, 15, 17, 2, 6), restSeconds: 60)
        addSet(exercise: "Straight arm cable pulldown", weight: 50.0, reps: 11, timestamp: date(2025, 10, 15, 17, 3, 54), restSeconds: 60)
        // Pull ups: 1 sets
        ...
        // Seated Incline Dumbell Curls: 3 sets
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 12.5, reps: 7, timestamp: date(2025, 10, 15, 17, 31, 5), restSeconds: 60)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 12.5, reps: 8, timestamp: date(2025, 10, 15, 17, 33, 8), restSeconds: 60)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 12.5, reps: 8, timestamp: date(2025, 10, 15, 17, 35, 22), restSeconds: 60)
        ...
        // Calf Raises: 4 sets
        addWarmUpSet(exercise: "Calf Raises", weight: 40.0, reps: 15, timestamp: date(2025, 10, 16, 20, 21, 58), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 50.0, reps: 14, timestamp: date(2025, 10, 16, 20, 23, 15), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 50.0, reps: 13, timestamp: date(2025, 10, 16, 20, 25, 45), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 50.0, reps: 14, timestamp: date(2025, 10, 16, 20, 27, 31), restSeconds: 60)
        ...
        addSet(exercise: "Chest press machine", weight: 56.0, reps: 10, timestamp: date(2025, 10, 17, 13, 31, 21), restSeconds: 60)
        ...
        // Dumbbell shoulder press: 3 sets
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 10, timestamp: date(2025, 10, 18, 10, 12, 28), restSeconds: 60)
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 9, timestamp: date(2025, 10, 18, 10, 19, 16), restSeconds: 60)
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 8, timestamp: date(2025, 10, 18, 10, 19, 20), restSeconds: 60)
        // Dumbbell lateral raises: 3 sets
        ...
        // Tricep Dips: 3 sets
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 9, timestamp: date(2025, 10, 18, 10, 37, 37), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 10, timestamp: date(2025, 10, 18, 10, 38, 25), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 10, timestamp: date(2025, 10, 18, 10, 42, 2), restSeconds: 60)
        // Overhead Tricep Rope Pulls: 4 sets
        ...
        // Tricep Dips: 4 sets
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 10, timestamp: date(2025, 10, 22, 19, 48, 13), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 10, timestamp: date(2025, 10, 22, 19, 50, 13), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 9, timestamp: date(2025, 10, 22, 19, 53, 3), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 9, timestamp: date(2025, 10, 22, 19, 55, 26), restSeconds: 60)
        ...
        // Calf Raises: 4 sets
        addSet(exercise: "Calf Raises", weight: 40.0, reps: 20, timestamp: date(2025, 10, 23, 19, 0, 45), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 50.0, reps: 14, timestamp: date(2025, 10, 23, 19, 4, 32), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 50.0, reps: 15, timestamp: date(2025, 10, 23, 19, 4, 36), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 50.0, reps: 15, timestamp: date(2025, 10, 23, 19, 6, 48), restSeconds: 60)
        ...
        addSet(exercise: "Calf Raises", weight: 40.0, reps: 16, timestamp: date(2025, 10, 28, 17, 12, 24), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 40.0, reps: 15, timestamp: date(2025, 10, 28, 17, 15, 5), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 40.0, reps: 15, timestamp: date(2025, 10, 28, 17, 17, 0), restSeconds: 60)
        ...
        // Calf Raises: 4 sets
        addSet(exercise: "Calf Raises", weight: 40.0, reps: 15, timestamp: date(2025, 10, 30, 19, 48, 41), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 40.0, reps: 15, timestamp: date(2025, 10, 30, 19, 50, 50), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 40.0, reps: 14, timestamp: date(2025, 10, 30, 19, 52, 23), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 40.0, reps: 15, timestamp: date(2025, 10, 30, 19, 53, 51), restSeconds: 60)
        // Box jumps: 3 sets
        ...
        // Dumbbell shoulder press: 3 sets
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 9, timestamp: date(2025, 11, 1, 9, 19, 27), restSeconds: 60)
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 9, timestamp: date(2025, 11, 1, 9, 22, 9), restSeconds: 60)
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 10, timestamp: date(2025, 11, 1, 9, 25, 37), restSeconds: 60)
        // Dumbbell lateral raises: 3 sets
        ...
        // Seated dumbbell curl (on knee): 1 sets
        addSet(exercise: "Seated dumbbell curl (on knee)", weight: 10.0, reps: 14, timestamp: date(2025, 11, 5, 17, 58, 15), restSeconds: 60)
        // Seated tricep dips: 1 sets
        ...
        // Dumbbell shoulder press: 2 sets
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 12, timestamp: date(2025, 11, 7, 17, 8, 20), restSeconds: 60)
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 8, timestamp: date(2025, 11, 7, 17, 11, 29), restSeconds: 60)
        // Chest Cable Flys: 3 sets
        ...
        // Tricep Dips: 4 sets
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 10, timestamp: date(2025, 11, 7, 17, 31, 26), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 12, timestamp: date(2025, 11, 7, 17, 33, 47), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 10, timestamp: date(2025, 11, 7, 17, 37, 33), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 7.0, reps: 8, timestamp: date(2025, 11, 7, 17, 39, 20), restSeconds: 60)
        // Tricep rope pushdown: 3 sets
        ...
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 8, timestamp: date(2025, 11, 7, 17, 48, 54), restSeconds: 60)

        // SESSION 37: 2025-11-08 16:25:44
        // Barbell squat: 4 sets
        addSet(exercise: "Barbell squat", weight: 50.0, reps: 8, timestamp: date(2025, 11, 8, 16, 25, 44), restSeconds: 60)
        addSet(exercise: "Barbell squat", weight: 60.0, reps: 10, timestamp: date(2025, 11, 8, 16, 27, 23), restSeconds: 60)
        addSet(exercise: "Barbell squat", weight: 6.0, reps: 11, timestamp: date(2025, 11, 8, 16, 30, 3), restSeconds: 60)
        addSet(exercise: "Barbell squat", weight: 60.0, reps: 10, timestamp: date(2025, 11, 8, 16, 33, 27), restSeconds: 60)
        // Pull ups: 3 sets
        ...
        // Seated Incline Dumbell Curls: 3 sets
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 11, timestamp: date(2025, 11, 8, 16, 54, 51), restSeconds: 60)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 12, timestamp: date(2025, 11, 8, 16, 57, 11), restSeconds: 60)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 12, timestamp: date(2025, 11, 8, 16, 59, 52), restSeconds: 60)
        // Dumbbell hammer curls : 3 sets
        ...
        // Calf Raises: 3 sets
        addSet(exercise: "Calf Raises", weight: 40.0, reps: 18, timestamp: date(2025, 11, 8, 17, 11, 4), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 50.0, reps: 16, timestamp: date(2025, 11, 8, 17, 12, 37), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 50.0, reps: 17, timestamp: date(2025, 11, 8, 17, 14, 30), restSeconds: 60)
        ...
        // Tricep Dips: 3 sets
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 12, timestamp: date(2025, 11, 10, 17, 56, 6), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 9, timestamp: date(2025, 11, 10, 17, 57, 47), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 5.0, reps: 10, timestamp: date(2025, 11, 10, 17, 59, 44), restSeconds: 60)
        ...
        // Dumbbell shoulder press: 3 sets
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 12, timestamp: date(2025, 11, 18, 17, 17, 12), restSeconds: 60)
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 11, timestamp: date(2025, 11, 18, 17, 20, 33), restSeconds: 60)
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 10, timestamp: date(2025, 11, 18, 17, 23, 22), restSeconds: 60)
        // Dumbbell lateral raises: 3 sets
        ...
        // Tricep Dips: 3 sets
        addSet(exercise: "Tricep Dips", weight: 7.5, reps: 8, timestamp: date(2025, 11, 18, 17, 33, 36), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 7.5, reps: 8, timestamp: date(2025, 11, 18, 17, 36, 6), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 7.5, reps: 8, timestamp: date(2025, 11, 18, 17, 39, 23), restSeconds: 60)
        ...
        addSet(exercise: "Straight arm cable pulldown", weight: 50.5, reps: 10, timestamp: date(2025, 11, 19, 17, 4, 40), restSeconds: 60)
        // Seated Incline Dumbell Curls: 3 sets
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 12, timestamp: date(2025, 11, 19, 17, 6, 8), restSeconds: 60)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 13, timestamp: date(2025, 11, 19, 17, 8, 53), restSeconds: 60)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 12, timestamp: date(2025, 11, 19, 17, 12, 23), restSeconds: 60)
        // Dumbbell hammer curls : 3 sets
        ...
        // Barbell squat: 4 sets
        addSet(exercise: "Barbell squat", weight: 60.0, reps: 10, timestamp: date(2025, 11, 20, 16, 11, 38), restSeconds: 60)
        addSet(exercise: "Barbell squat", weight: 60.0, reps: 11, timestamp: date(2025, 11, 20, 16, 17, 26), isPB: true)
        addSet(exercise: "Barbell squat", weight: 60.0, reps: 11, timestamp: date(2025, 11, 20, 16, 21, 30), restSeconds: 60)
        addSet(exercise: "Barbell squat", weight: 60.0, reps: 6, timestamp: date(2025, 11, 20, 16, 25, 1), restSeconds: 180)
        // Deadlifts: 3 sets
        ...
        addSet(exercise: "Deadlifts", weight: 60.0, reps: 10, timestamp: date(2025, 11, 20, 16, 33, 10), restSeconds: 60)
        // Hamstring Curls: 4 sets
        ...
        addSet(exercise: "Calf Raises", weight: 60.0, reps: 14, timestamp: date(2025, 11, 20, 16, 54, 40), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 60.0, reps: 14, timestamp: date(2025, 11, 20, 16, 58, 2), restSeconds: 60)
        // Dumbbell lunges: 3 sets
        ...
        // Straight arm cable pulldown: 2 sets
        addSet(exercise: "Straight arm cable pulldown", weight: 50.5, reps: 10, timestamp: date(2025, 11, 22, 15, 30, 25), restSeconds: 60)
        ...
        // Tricep Dips: 4 sets
        addSet(exercise: "Tricep Dips", weight: 0.0, reps: 10, timestamp: date(2025, 11, 23, 15, 58, 6), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 7.5, reps: 9, timestamp: date(2025, 11, 23, 16, 2, 5), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 7.5, reps: 9, timestamp: date(2025, 11, 23, 16, 4, 28), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 7.5, reps: 8, timestamp: date(2025, 11, 23, 16, 9, 52), restSeconds: 60)
        // Chest Cable Flys: 2 sets
        ...
        // Dumbbell shoulder press: 2 sets
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 12, timestamp: date(2025, 11, 23, 16, 23, 19), restSeconds: 60)
        addSet(exercise: "Dumbbell shoulder press", weight: 15.0, reps: 15, timestamp: date(2025, 11, 23, 16, 27, 10), restSeconds: 60)
        // Tricep rope pushdown: 3 sets
        ...
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 14, timestamp: date(2025, 11, 24, 18, 8, 43), restSeconds: 60)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 12.5, reps: 9, timestamp: date(2025, 11, 24, 18, 12, 9), restSeconds: 60)
        // Knees to toe: 3 sets
        ...
        // Calf Raises: 4 sets
        addSet(exercise: "Calf Raises", weight: 40.0, reps: 20, timestamp: date(2025, 11, 25, 17, 25, 8), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 40.0, reps: 19, timestamp: date(2025, 11, 25, 17, 27, 7), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 40.0, reps: 15, timestamp: date(2025, 11, 25, 17, 29, 3), restSeconds: 60)
        addSet(exercise: "Calf Raises", weight: 40.0, reps: 16, timestamp: date(2025, 11, 25, 17, 31, 9), restSeconds: 180)
        // Leg Raises: 3 sets
        ...
        addSet(exercise: "Box jumps", weight: 5.0, reps: 15, timestamp: date(2025, 11, 25, 17, 47, 13), restSeconds: 60)
        // T Bar Row: 2 sets
        ...
        // SESSION 49: 2025-11-28 15:48:33
        // Dumbbell shoulder press: 2 sets
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 15, timestamp: date(2025, 11, 28, 15, 48, 33))
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 12, timestamp: date(2025, 11, 28, 15, 51, 3), restSeconds: 60)
        // Reverse Cable Flys: 3 sets
        ...
        // Seated Incline Dumbell Curls: 3 sets
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 12.5, reps: 10, timestamp: date(2025, 11, 28, 16, 31, 56), isPB: true)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 12.5, reps: 10, timestamp: date(2025, 11, 28, 16, 34, 59), restSeconds: 60)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 12.5, reps: 7, timestamp: date(2025, 11, 28, 16, 37, 36), restSeconds: 60)
        // Dumbbell hammer curls : 3 sets
        ...
        // Tricep Dips: 4 sets
        addBonusSet(exercise: "Tricep Dips", weight: 0.0, reps: 12, timestamp: date(2025, 11, 29, 17, 38, 4), restSeconds: 60)
        addBonusSet(exercise: "Tricep Dips", weight: 0.0, reps: 15, timestamp: date(2025, 11, 29, 17, 40, 40), restSeconds: 60)
        addBonusSet(exercise: "Tricep Dips", weight: 0.0, reps: 13, timestamp: date(2025, 11, 29, 17, 43, 0), restSeconds: 60)
        addBonusSet(exercise: "Tricep Dips", weight: 0.0, reps: 12, timestamp: date(2025, 11, 29, 17, 44, 57), restSeconds: 60)
        ...
        addSet(exercise: "Pull ups", weight: 0.0, reps: 9, timestamp: date(2025, 12, 1, 16, 28, 16), isPB: true)
        ...
        // Seated Incline Dumbell Curls: 3 sets
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 12.5, reps: 10, timestamp: date(2025, 12, 1, 16, 57, 24), restSeconds: 60)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 12.5, reps: 9, timestamp: date(2025, 12, 1, 17, 0, 3), restSeconds: 60)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 12.5, reps: 9, timestamp: date(2025, 12, 1, 17, 2, 34), restSeconds: 180)
        // Dumbbell hammer curls : 3 sets
        ...
        addSet(exercise: "Incline chest press machine", weight: 45.0, reps: 10, timestamp: date(2025, 12, 3, 16, 52, 32), restSeconds: 60)
        // Chest Press: 3 sets
        ...
        // Tricep Dips: 3 sets
        addSet(exercise: "Tricep Dips", weight: 7.5, reps: 10, timestamp: date(2025, 12, 3, 17, 6, 4), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 7.5, reps: 10, timestamp: date(2025, 12, 3, 17, 8, 20), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 7.5, reps: 11, timestamp: date(2025, 12, 3, 17, 12, 0), restSeconds: 60)
        // Single cable lateral raise: 4 sets
        ...
        // Dumbbell shoulder press: 3 sets
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 15, timestamp: date(2025, 12, 3, 17, 26, 34), restSeconds: 60)
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 10, timestamp: date(2025, 12, 3, 17, 29, 13), restSeconds: 60)
        addSet(exercise: "Dumbbell shoulder press", weight: 17.5, reps: 10, timestamp: date(2025, 12, 3, 17, 31, 50), restSeconds: 180)
        // Chest Cable Flys: 4 sets
        ...
        // Tricep Dips: 3 sets
        addWarmUpSet(exercise: "Tricep Dips", weight: 7.5, reps: 11, timestamp: date(2025, 12, 10, 20, 36, 36), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 7.5, reps: 11, timestamp: date(2025, 12, 10, 20, 36, 59), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 7.5, reps: 15, timestamp: date(2025, 12, 10, 20, 37, 32), restSeconds: 60)

        // SESSION 54: 2025-12-12 15:09:12
        // Tricep Dips: 3 sets
        addSet(exercise: "Tricep Dips", weight: 7.5, reps: 15, timestamp: date(2025, 12, 12, 15, 9, 12), restSeconds: 60)
        addSet(exercise: "Tricep Dips", weight: 10.0, reps: 6, timestamp: date(2025, 12, 12, 15, 9, 55))
        addSet(exercise: "Tricep Dips", weight: 10.0, reps: 6, timestamp: date(2025, 12, 12, 16, 9, 12), restSeconds: 60)
        ...
        // Tricep Dips: 4 sets
        addBonusSet(exercise: "Tricep Dips", weight: 0.0, reps: 10, timestamp: date(2025, 12, 29, 17, 1, 2), restSeconds: 60)
        addBonusSet(exercise: "Tricep Dips", weight: 5.0, reps: 10, timestamp: date(2025, 12, 29, 17, 3, 1), restSeconds: 60)
        addBonusSet(exercise: "Tricep Dips", weight: 0.0, reps: 10, timestamp: date(2025, 12, 29, 17, 5, 42), restSeconds: 60)
        addBonusSet(exercise: "Tricep Dips", weight: 0.0, reps: 10, timestamp: date(2025, 12, 29, 17, 7, 49), restSeconds: 180)
        // Overhead Tricep Rope Pulls: 4 sets
        ...
        // Seated Incline Dumbell Curls: 3 sets
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 11, timestamp: date(2026, 1, 4, 15, 11, 54), restSeconds: 180)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 12, timestamp: date(2026, 1, 4, 15, 15, 21), restSeconds: 180)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 12, timestamp: date(2026, 1, 4, 15, 19, 3), restSeconds: 180)
        ...
        // Leg Raises: 1 sets
        addWarmUpSet(exercise: "Leg Raises", weight: 43.0, reps: 10, timestamp: date(2026, 1, 6, 16, 14, 19))
        // Leg press: 5 sets
        ...
        // Calf Raises: 3 sets
        addSet(exercise: "Calf Raises", weight: 30.0, reps: 20, timestamp: date(2026, 1, 6, 16, 30, 53), restSeconds: 131)
        addSet(exercise: "Calf Raises", weight: 40.0, reps: 14, timestamp: date(2026, 1, 6, 16, 33, 5), restSeconds: 144)
        addSet(exercise: "Calf Raises", weight: 40.0, reps: 13, timestamp: date(2026, 1, 6, 16, 35, 29), restSeconds: 180)
        // Romanian deadlift : 3 sets
        ...
        // Barbell squat: 3 sets
        addSet(exercise: "Barbell squat", weight: 60.0, reps: 5, timestamp: date(2026, 1, 6, 16, 51, 44), restSeconds: 180)
        addSet(exercise: "Barbell squat", weight: 60.0, reps: 8, timestamp: date(2026, 1, 6, 16, 56, 54), restSeconds: 180)
        addSet(exercise: "Barbell squat", weight: 60.0, reps: 8, timestamp: date(2026, 1, 6, 17, 0, 17))
        // Hang cleans: 3 sets
        ...
        // SESSION 58: 2026-01-07 12:08:23
        // Hamstring Curls: 1 sets
        addSet(exercise: "Hamstring Curls", weight: 48.5, reps: 10, timestamp: date(2026, 1, 7, 12, 8, 23))

        // SESSION 59: 2026-01-07 16:33:36
        // Chest Press: 4 sets
        ...
        // Tricep Dips: 3 sets
        addSet(exercise: "Tricep Dips", weight: 10.0, reps: 9, timestamp: date(2026, 1, 7, 17, 19, 59), restSeconds: 146)
        addSet(exercise: "Tricep Dips", weight: 10.0, reps: 9, timestamp: date(2026, 1, 7, 17, 22, 26), restSeconds: 163)
        addSet(exercise: "Tricep Dips", weight: 10.0, reps: 8, timestamp: date(2026, 1, 7, 17, 25, 9), restSeconds: 180)
        // Overhead Tricep Rope Pulls: 3 sets
        ...
        addDropSet(exercise: "Overhead Tricep Rope Pulls", weight: 39.5, reps: 13, timestamp: date(2026, 1, 7, 17, 35, 27))
        // Lu Raise: 1 sets
        ...
        // Lu Raise: 1 sets
        addSet(exercise: "Lu Raise", weight: 5.0, reps: 10, timestamp: date(2026, 1, 7, 17, 40, 40))
        // Front lateral raise plates: 1 sets
        addSet(exercise: "Front lateral raise plates", weight: 10.0, reps: 10, timestamp: date(2026, 1, 7, 17, 40, 46))

        // SESSION 60: 2026-01-09 08:28:09
        // Tricep Dips: 1 sets
        addSet(exercise: "Tricep Dips", weight: 10.0, reps: 8, timestamp: date(2026, 1, 9, 8, 28, 9), restSeconds: 180)

        // SESSION 61: 2026-01-09 15:32:11
        // Pull ups: 4 sets
        ...
        // SESSION 62: 2026-01-13 21:26:26
        // Dumbbell hammer curls : 1 sets
        addSet(exercise: "Dumbbell hammer curls ", weight: 12.5, reps: 14, timestamp: date(2026, 1, 13, 21, 26, 26))

        // SESSION 63: 2026-01-14 16:16:26
        // Deadlifts (Trapbar): 4 sets
        ...
        addSet(exercise: "Reverse Cable Flys", weight: 20.0, reps: 12, timestamp: date(2026, 1, 14, 16, 56, 5), restSeconds: 180, isPB: true)
        ...
        // SESSION 64: 2026-01-25 16:09:36
        // Pull ups: 6 sets
        ...
        addSet(exercise: "Seated cable row", weight: 59.5, reps: 10, timestamp: date(2026, 1, 25, 16, 23, 37))
        ...
        // Seated Incline Dumbell Curls: 4 sets
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 13, timestamp: date(2026, 1, 25, 16, 43, 5), restSeconds: 180)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 12, timestamp: date(2026, 1, 25, 16, 46, 28), restSeconds: 133)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 11, timestamp: date(2026, 1, 25, 16, 48, 41), restSeconds: 180)
        addSet(exercise: "Seated Incline Dumbell Curls", weight: 10.0, reps: 10, timestamp: date(2026, 1, 25, 16, 54, 2))
        // Barbell shoulder press: 3 sets
        ...
        // Calf Raises: 3 sets
        addSet(exercise: "Calf Raises", weight: 40.0, reps: 15, timestamp: date(2026, 1, 25, 16, 59, 50), restSeconds: 103)
        ...
        addSet(exercise: "Dumbbell shoulder press", weight: 20.0, reps: 8, timestamp: date(2026, 1, 27, 17, 4, 26), restSeconds: 147)
        addSet(exercise: "Dumbbell shoulder press", weight: 20.0, reps: 10, timestamp: date(2026, 1, 27, 17, 6, 53), restSeconds: 172, isPB: true)
        addSet(exercise: "Dumbbell shoulder press", weight: 20.0, reps: 8, timestamp: date(2026, 1, 27, 17, 9, 46), restSeconds: 180)
        addSet(exercise: "Dumbbell shoulder press", weight: 20.0, reps: 7, timestamp: date(2026, 1, 27, 17, 12, 54), restSeconds: 180)
        // Dumbbell lateral raises: 4 sets
        ...
        // Ball tricep pushdown: 3 sets
        addSet(exercise: "Ball tricep pushdown", weight: 23.0, reps: 12, timestamp: date(2026, 1, 27, 17, 28, 49), restSeconds: 153, isPB: true)
        ...
        // Tricep Dips: 3 sets
        addSet(exercise: "Tricep Dips", weight: 10.0, reps: 10, timestamp: date(2026, 1, 27, 17, 37, 28), restSeconds: 110)
        ...
        // SESSION 68: 2026-01-30 17:17:57
        // Press ups: 9 sets
        ...
        // SESSION 69: 2026-02-03 16:17:55
        // Chest Press: 4 sets
        ...
        addSet(exercise: "Chest Press", weight: 60.0, reps: 8, timestamp: date(2026, 2, 3, 16, 25, 46), isPB: true)
        // Chest Cable Flys: 3 sets
        ...
        addSet(exercise: "Chest Cable Flys", weight: 20.0, reps: 15, timestamp: date(2026, 2, 3, 16, 33, 43))
        // Single cable lateral raise: 3 sets
        ...
        addSet(exercise: "Single cable lateral raise", weight: 20.0, reps: 12, timestamp: date(2026, 2, 3, 16, 41, 47))
        // Incline Dumbbell Chest Press: 3 sets
        ...
        addSet(exercise: "Incline Dumbbell Chest Press", weight: 25.0, reps: 7, timestamp: date(2026, 2, 3, 16, 50, 7))
        // Dumbbell shoulder press: 3 sets
        addSet(exercise: "Dumbbell shoulder press", weight: 20.0, reps: 8, timestamp: date(2026, 2, 3, 16, 53, 26), restSeconds: 142)
        addSet(exercise: "Dumbbell shoulder press", weight: 20.0, reps: 7, timestamp: date(2026, 2, 3, 16, 55, 48), restSeconds: 156)
        addSet(exercise: "Dumbbell shoulder press", weight: 20.0, reps: 8, timestamp: date(2026, 2, 3, 16, 58, 24))
        // Tricep Dips: 3 sets
        addSet(exercise: "Tricep Dips", weight: 10.0, reps: 10, timestamp: date(2026, 2, 3, 17, 1, 16), restSeconds: 108)
        addSet(exercise: "Tricep Dips", weight: 10.0, reps: 10, timestamp: date(2026, 2, 3, 17, 3, 4), restSeconds: 174)
        addSet(exercise: "Tricep Dips", weight: 10.0, reps: 11, timestamp: date(2026, 2, 3, 17, 5, 59), isPB: true)
        // Tricep rope pushdown: 4 sets
